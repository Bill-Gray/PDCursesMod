...
extern char PDC_font_name[FACESIZE];
extern int PDC_font_size;

extern void PDC_set_font_box(HWND hwnd);
extern void PDC_setup_font(HPS hps);
extern void PDC_screen_to_pixel(int sx, int sy, RECTL *rect);
extern void PDC_pixel_to_screen(int px, int py, int *sx, int *sy);
extern int PDC_choose_a_new_font(char font[FACESIZE], int *fontsize);
extern int PDC_get_mouse_event_from_queue( void);
