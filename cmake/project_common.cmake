...
IF(PDC_DLL_BUILD)
    ...
    IF(${PROJECT_NAME} STREQUAL "sdl2")
        IF(PDC_WIDE)
            TARGET_LINK_LIBRARIES (${PDCURSE_PROJ} ${SDL2_LIBRARIES} ${SDL2_TTF_LIBRARIES} ${WINDOWS_KIT_UM_LIBS})
        ELSE()
            TARGET_LINK_LIBRARIES (${PDCURSE_PROJ} ${SDL2_LIBRARIES} ${WINDOWS_KIT_UM_LIBS})
        ENDIF()
    ELSE()
        TARGET_LINK_LIBRARIES (${PDCURSE_PROJ} ${WINDOWS_KIT_UM_LIBS})
    ENDIF()
...
IF (WIN32)
    ...
    SET(WINDOWS_KIT_UM_LIBS gdi32.lib winspool.lib shell32.lib ole32.lib comdlg32.lib advapi32.lib)
    SET(WINDOWS_KIT_UM_SDL2_LIBS version.lib winmm.lib imm32.lib)
...
FUNCTION (define_exe dir _name)
    ...
    TARGET_LINK_LIBRARIES (${exe_name} ${PDCURSE_PROJ} ${WINDOWS_KIT_UM_LIBS})
    ADD_DEPENDENCIES (${exe_name} ${PDCURSE_PROJ})
    INSTALL (TARGETS ${exe_name} RUNTIME DESTINATION ${PDCURSES_DIST}/bin/${PROJECT_NAME} COMPONENT applications CONFIGURATIONS)
...
FUNCTION (define_sdl2_exe dir _name)
    ...
    ADD_EXECUTABLE (${exe_name} ${CMAKE_CURRENT_SOURCE_DIR}/${dir}/${_name}.c)
    IF(PDC_WIDE)
        TARGET_LINK_LIBRARIES (${exe_name} ${PDCURSE_PROJ}
