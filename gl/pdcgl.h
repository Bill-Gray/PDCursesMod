...
#define PDC_GL_RESIZE_STRETCH 1 /* Stretches the contents to fill the whole screen. */
#define PDC_GL_RESIZE_SCALE 2 /* Same as above, but preserves aspect ratio. */
#define PDC_GL_RESIZE_INTEGER 3 /* Resizes in integer steps. */
#define PDC_GL_INTERPOLATE_NEAREST 0 /* Nearest-neighbor interpolation for text. */
