PDCurses for SDL 3.x
====================

This is a port of PDCurses for version 3.x of SDL (aka SDL3).


Building
--------

- On *nix (including Linux and Mac OS X), run "make" in the sdl3
...
- The makefile recognizes the optional PDCURSES_SRCDIR environment
  ...
  characters, but depends on the SDL3_ttf library, instead of using
...
character mapping for chtypes is UTF-32.
...
SDL3 modifications by Joachim de Groot
